        ...
        <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
          <nav className="space-y-1">
            ...
            <NavItem
              ...
              active={pathname === "/state-dashboard"}
            />
            ...
            <NavItem
              ...
              active={pathname.includes("/state-dashboard/manage-team")}
            />
            ...
            <NavItem
              href="/state-dashboard/performance"
            ...
            <NavItem
              href="/state-dashboard/personal-details"
              icon={FaUserCog}
              label="Profile"
              active={pathname.includes("/state-dashboard/personal-details")}
            />
          </nav>
        </div>
        ...
        {isWalletModalOpen && (
          <Modal onClose={() => setIsWalletModalOpen(false)}>
            <div className="flex justify-between items-center mb-4">
              ...
              <button onClick={() => setIsWalletModalOpen(false)} className="text-gray-500 hover:text-gray-700">
                <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 18L18 6M6 6l12 12" />
                </svg>
              </button>
