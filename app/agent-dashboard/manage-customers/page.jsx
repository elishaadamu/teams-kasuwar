...
const ManageCustomersPage = () => {
  ...
  const fetchCustomers = async () => {
    ...
    try {
      ...
      setCustomers(referredUsers.filter((user) => user.role === "user"));

      setFilteredCustomers(referredUsers);
    } catch (error) {
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            ...
            <button
              ...
              className="flex items-center gap-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white py-3 px-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105" // This class was changed from manage-bds to manage-customers
            >
