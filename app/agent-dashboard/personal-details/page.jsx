...
import { FaUserEdit, FaUniversity, FaUserCheck, FaIdCard, FaMapMarkerAlt, FaPhoneAlt, FaEnvelope, FaStore } from "react-icons/fa";
      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl shadow-blue-900/5 p-8 md:p-12 border border-gray-100">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 pb-10 border-b border-gray-100 gap-6">
          <div className="flex items-center gap-6">
            <div className="w-20 h-20 bg-gradient-to-br from-emerald-600 to-teal-700 rounded-3xl flex items-center justify-center text-white text-3xl font-bold shadow-lg shadow-emerald-500/20">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3.5 rounded-2xl font-bold transition-all duration-300 shadow-lg ${
              isEditing 
                ...
                : "bg-emerald-600 text-white hover:bg-emerald-700 hover:-translate-y-1 shadow-emerald-600/20"
            }`}
          >
            {isEditing ? (
              "Cancel"
        ...
        <div className="space-y-12">
          ...
          {profile.role === "vendor" && (
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 bg-orange-50/20 p-8 rounded-3xl border border-orange-100/50">
                <div className="md:col-span-2">
                  <FormField
                    label="Business Name"
                    name="businessName"
          ...
          <section className="bg-slate-900 rounded-3xl p-8 text-white flex flex-col md:flex-row justify-between items-center gap-6 border border-slate-800">
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">Profile Level</p>
        ...
        {isEditing && (
          <div className="flex justify-end mt-12 pt-8 border-t border-gray-100">
            <button
              ...
              disabled={loading}
              className="px-10 py-4 text-sm font-black text-white bg-emerald-600 rounded-2xl hover:bg-emerald-700 disabled:bg-emerald-400 disabled:cursor-not-allowed transition-all duration-300 shadow-xl shadow-emerald-600/20 hover:-translate-y-1"
            >
              {loading ? "Syncing..." : "Save My Details"}
            </button>
          </div>
        )}
      </div>
