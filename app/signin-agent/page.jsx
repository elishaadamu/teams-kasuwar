  ...
  const handleSignin = async (e) => {
    ...
    try {
      const response = await axios.post(
        apiUrl(API_CONFIG.ENDPOINTS.AUTH.SIGNIN_AGENT),
        payload
      );
      ...
      const encryptedUser = encryptData(response.data.agent);
  ...
  return (
    <div className="flex justify-center items-center my-16">
      ...
      >
        ...
        <h2 className="text-left text-gray-500">Signin as an Agent</h2>
