      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl shadow-blue-900/5 p-8 md:p-12 border border-gray-100">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 pb-10 border-b border-gray-100 gap-6">
          <div className="flex items-center gap-6">
            <div className="w-20 h-20 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-3xl flex items-center justify-center text-white text-3xl font-bold shadow-lg shadow-blue-500/20">
        ...
        <div className="space-y-12">
          ...
          <section>
            <div className="flex items-center gap-3 mb-6">
              <div className="w-8 h-8 bg-indigo-50 rounded-lg flex items-center justify-center">
                <FaUniversity className="text-indigo-600 text-sm" />
              </div>
              <h2 className="text-lg font-bold text-gray-800 tracking-tight">Bank Account Details</h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-8 bg-indigo-50/20 p-8 rounded-3xl border border-indigo-100/50">
              <FormField
                label="Bank Name"
                name="bankName"
          ...
          <section className="bg-slate-900 rounded-3xl p-8 text-white flex flex-col md:flex-row justify-between items-center gap-6 border border-slate-800">
            <div className="flex items-center gap-5">
              ...
              <div>
                <p className="text-slate-400 text-sm font-bold uppercase tracking-widest">Current Assignment</p>
                <h3 className="text-xl font-black text-white capitalize">{profile.role || "Regional Lead"}</h3>
              </div>
            </div>
            <div className="px-5 py-2.5 bg-blue-500/10 border border-blue-500/20 rounded-xl text-blue-400 text-sm font-black uppercase tracking-widest">
              Verified Role
            </div>
          </section>
        </div>
        ...
        {isEditing && (
          <div className="flex justify-end mt-12 pt-8 border-t border-gray-100">
            <button
              ...
              disabled={loading}
              className="px-10 py-4 text-sm font-black text-white bg-blue-600 rounded-2xl hover:bg-blue-700 disabled:bg-blue-400 disabled:cursor-not-allowed transition-all duration-300 shadow-xl shadow-blue-600/20 hover:-translate-y-1"
            >
              {loading ? "Syncing..." : "Update Profile Now"}
            </button>
          </div>
        )}
      </div>
